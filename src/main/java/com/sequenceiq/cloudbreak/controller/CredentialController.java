...
public class CredentialController {
    ...
    @ApiOperation(value = CredentialOpDescription.GET_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.CREDENTIAL_NOTES)
    ...
    @ApiOperation(value = CredentialOpDescription.GET_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.CREDENTIAL_NOTES)
    ...
    @ApiOperation(value = CredentialOpDescription.GET_ID, produces = ContentType.JSON, notes = Notes.CREDENTIAL_NOTES)
    ...
    @ApiOperation(value = CredentialOpDescription.DELETE_ID, produces = ContentType.JSON, notes = Notes.CREDENTIAL_NOTES)
    ...
    @ApiOperation(value = CredentialOpDescription.DELETE_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.CREDENTIAL_NOTES)
    ...
    @ApiOperation(value = CredentialOpDescription.DELETE_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.CREDENTIAL_NOTES)
