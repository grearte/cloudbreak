...
public class BlueprintController {
    ...
    @ApiOperation(value = BlueprintOpDescription.GET_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.BLUEPRINT_NOTES)
    ...
    @ApiOperation(value = BlueprintOpDescription.GET_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.BLUEPRINT_NOTES)
    ...
    @ApiOperation(value = BlueprintOpDescription.GET_ID, produces = ContentType.JSON, notes = Notes.BLUEPRINT_NOTES)
    ...
    @ApiOperation(value = BlueprintOpDescription.DELETE_ID, produces = ContentType.JSON, notes = Notes.BLUEPRINT_NOTES)
    @RequestMapping(value = "blueprints/{id}", method = RequestMethod.DELETE)
    @ResponseBody
    public ResponseEntity<BlueprintResponse> deleteBlueprint(@ApiIgnore @ModelAttribute("user") CbUser user, @PathVariable Long id) {
        blueprintService.delete(id, user);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    @ApiOperation(value = BlueprintOpDescription.DELETE_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.BLUEPRINT_NOTES)
    ...
    @ApiOperation(value = BlueprintOpDescription.DELETE_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.BLUEPRINT_NOTES)
