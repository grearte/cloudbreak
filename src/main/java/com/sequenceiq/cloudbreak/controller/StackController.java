...
public class StackController {
    ...
    @ApiOperation(value = StackOpDescription.GET_ID, produces = ContentType.JSON, notes = Notes.STACK_NOTES)
    @RequestMapping(value = "stacks/{id}", method = RequestMethod.GET)
    @ResponseBody
    public ResponseEntity<StackResponse> getStack(@PathVariable Long id) {
    ...
    @ApiOperation(value = StackOpDescription.GET_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.STACK_NOTES)
    ...
    @ApiOperation(value = StackOpDescription.GET_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.STACK_NOTES)
    ...
    @ApiOperation(value = StackOpDescription.DELETE_ID, produces = ContentType.JSON, notes = Notes.STACK_NOTES)
    ...
    @ApiOperation(value = StackOpDescription.DELETE_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.STACK_NOTES)
    ...
    @ApiOperation(value = StackOpDescription.DELETE_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.STACK_NOTES)
