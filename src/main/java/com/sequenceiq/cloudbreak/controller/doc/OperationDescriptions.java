...
public class OperationDescriptions {
    public static class BlueprintOpDescription {
        ...
        public static final String GET_PRIVATE_NAME = "retrieve a private blueprint by name";
        public static final String GET_PUBLIC_NAME = "retrieve a public or private (owned) blueprint by name";
        public static final String GET_ID = "retrieve blueprint by id";
        public static final String DELETE_PRIVATE_NAME = "delete private blueprint by name";
        public static final String DELETE_PUBLIC_NAME = "delete public (owned) or private blueprint by name";
        public static final String DELETE_ID = "delete blueprint by id";
    }
    ...
    public static class TemplateOpDescription {
        ...
        public static final String GET_PRIVATE_NAME = "retrieve a private template by name";
        public static final String GET_PUBLIC_NAME = "retrieve a public or private (owned) template by name";
        public static final String GET_ID = "retrieve template by id";
        public static final String DELETE_PRIVATE_NAME = "delete private template by name";
        public static final String DELETE_PUBLIC_NAME = "delete public (owned) or private template by name";
        public static final String DELETE_ID = "delete template by id";
    }
    ...
    public static class CredentialOpDescription {
        ...
        public static final String GET_PRIVATE_NAME = "retrieve a private credential by name";
        public static final String GET_PUBLIC_NAME = "retrieve a public or private (owned) credential by name";
        public static final String GET_ID = "retrieve credential by id";
        public static final String DELETE_PRIVATE_NAME = "delete private credential by name";
        public static final String DELETE_PUBLIC_NAME = "delete public (owned) or private credential by name";
        public static final String DELETE_ID = "delete credential by id";
    ...
    public static class StackOpDescription {
        ...
        public static final String GET_PRIVATE_NAME = "retrieve a private stack by name";
        public static final String GET_PUBLIC_NAME = "retrieve a public or private (owned) stack by name";
        public static final String GET_ID = "retrieve stack by id";
        public static final String DELETE_PRIVATE_NAME = "delete private stack by name";
        public static final String DELETE_PUBLIC_NAME = "delete public (owned) or private stack by name";
        public static final String DELETE_ID = "delete stack by id";
    ...
    public static class ClusterOpDescription {
        public static final String POST_FOR_STACK = "create cluster as for stack";
    ...
    public static class RecipeOpDescription {
        ...
        public static final String GET_PRIVATE_NAME = "retrieve a private recipe by name";
        public static final String GET_PUBLIC_NAME = "retrieve a public or private (owned) recipe by name";
        public static final String GET_ID = "retrieve recipe by id";
        public static final String DELETE_PRIVATE_NAME = "delete private recipe by name";
        public static final String DELETE_PUBLIC_NAME = "delete public (owned) or private recipe by name";
        public static final String DELETE_ID = "delete recipe by id";
    }
