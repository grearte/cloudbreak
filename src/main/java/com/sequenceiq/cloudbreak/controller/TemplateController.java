...
public class TemplateController {
    ...
    @ApiOperation(value = TemplateOpDescription.GET_ID, produces = ContentType.JSON, notes = Notes.TEMPLATE_NOTES)
    ...
    @ApiOperation(value = TemplateOpDescription.GET_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.TEMPLATE_NOTES)
    ...
    @ApiOperation(value = TemplateOpDescription.GET_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.TEMPLATE_NOTES)
    ...
    @ApiOperation(value = TemplateOpDescription.DELETE_ID, produces = ContentType.JSON, notes = Notes.TEMPLATE_NOTES)
    ...
    @ApiOperation(value = TemplateOpDescription.DELETE_PUBLIC_NAME, produces = ContentType.JSON, notes = Notes.TEMPLATE_NOTES)
    ...
    @ApiOperation(value = TemplateOpDescription.DELETE_PRIVATE_NAME, produces = ContentType.JSON, notes = Notes.TEMPLATE_NOTES)
